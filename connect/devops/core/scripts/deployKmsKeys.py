...
if __name__ == '__main__':
    ...
    parser.add_argument("--SSMKMSKeySSEArnName", dest="SSMKMSKeySSEArnName", required=True, metavar="<SSMKMSKeySSEArnName>",
                        help="SSM Key KMS ARN for SSE")
    parser.add_argument("--SSMKMSKeyDataArnName", dest="SSMKMSKeyDataArnName", required=True, metavar="<SSMKMSKeyDataArnName>",
                        help="SSM Key KMS ARN fo Data")
    ...
    try:       
        ...
        input_params['SSMKMSKeySSEArnName'] = args.SSMKMSKeySSEArnName
        input_params['SSMKMSKeyDataArnName'] = args.SSMKMSKeyDataArnName
        ...
        cloudformation.create_stack(StackName=input_params['stackName'],\
                                    ...
                                    Parameters=[{'ParameterKey':'UserArn','ParameterValue':input_params['UserArn']},
                                                {'ParameterKey':'SSMKMSKeySSEArnName','ParameterValue':input_params['SSMKMSKeySSEArnName']},
                                                {'ParameterKey':'SSMKMSKeyDataArnName','ParameterValue':input_params['SSMKMSKeyDataArnName']}]
                                    )
