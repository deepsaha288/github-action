...
'''
'''
python3 -W ignore core/scripts/createWAFRuleALB.py --name cum-waf-rule-alb-lgen --metricName "webACLforLoadBalancer" --ssmWAFparameterName WebAclIdALB --logLevel INFO
'''
