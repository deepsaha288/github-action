...
if __name__ == '__main__':
    ...
    parser.add_argument("--SSMKMSKeyArnNameElasticsearch", dest="SSMKMSKeyArnNameElasticsearch", required=True, metavar="<SSMKMSKeyArnNameElasticsearch>", help="SSM parameter for Elasticsearch KMS Key ARN")
    ...
    try:       
        ...
        input_params['SSMKMSKeyArnNameElasticsearch'] = args.SSMKMSKeyArnNameElasticsearch
        ...
        cloudformation.create_stack(StackName=input_params['stackName'],\
                                    ...
                                    {'ParameterKey':'SSMKMSKeyArnNameElasticsearch','ParameterValue':input_params['SSMKMSKeyArnNameElasticsearch']}
                                    ]
                                    )
