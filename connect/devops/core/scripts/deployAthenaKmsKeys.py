...
'''
'''
python3 -W ignore core/scripts/deployAthenaKmsKeys.py --stackName LoadGen-Core-Athena-KMS --templateUrl https://cl-cumulus-cftemplates-lgenprod.s3.eu-central-1.amazonaws.com/cum-athena-kms-key.yaml --UserArn arn:aws:iam::864341830589:user/CumulusLoadGen-AWScli-ProgAccess --SSMAthenaKMSKeySSEArnName athena_kms_key_arn --logLevel INFO
'''
...
if __name__ == '__main__':
    ...
    parser.add_argument("--SSMAthenaKMSKeySSEArnName", dest="SSMAthenaKMSKeySSEArnName", required=True,
                        metavar="<SSMAthenaKMSKeySSEArnName>", help="SSM Key Athena-KMS ARN for SSE")
    ...
    try:
        ...
        input_params['SSMAthenaKMSKeySSEArnName'] = args.SSMAthenaKMSKeySSEArnName
        ...
        cloudformation.create_stack(StackName=input_params['stackName'],\
                                    ...
                                    Parameters=[{'ParameterKey':'UserArn','ParameterValue':input_params['UserArn']},
                                                {'ParameterKey':'SSMAthenaKMSKeySSEArnName','ParameterValue':input_params['SSMAthenaKMSKeySSEArnName']}]
                                    )
