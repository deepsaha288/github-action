...
python3 -W ignore core/scripts/deployMSKIAMPolicies.py --stackName Loadgen-MSK-Policy --templateUrl https://cl-cumulus-cftemplates-lgenprod.s3.eu-central-1.amazonaws.com/cum-msk-policy.yaml --MSKClusterName MSK-POC-WITH-STORM-24 --AscendRoleARN arn:aws:iam::915898395253:role/task_execution_role --logLevel INFO
...
if __name__ == '__main__':
    ...
    parser.add_argument("--AscendRoleARN", dest="AscendRoleARN", required=True, metavar="<AscendRoleARN>", default="",
                       help="Ascend IAM Role ARN")
    ...
    try:
        ...
        input_params['AscendRoleARN'] = args.AscendRoleARN
        ...
        cloudformation.create_stack(StackName=input_params['stackName'],\
                                    ...
                                    Parameters=[{'ParameterKey':'MSKClusterName','ParameterValue':input_params['MSKClusterName']},
                                                {'ParameterKey':'AscendRoleARN','ParameterValue':input_params['AscendRoleARN']}],\
